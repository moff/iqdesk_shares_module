<form method="post" action="<?= base_url() ?>shares/shares/create" class="modal-wrapper column-4" validate-form="true"
    ...
    <div class="modal-content">
        ...
        <div class="inline-form-row">
            ...
            <div class="column-6">
                <select name="status">
                    <option selected value="1"><?= $this->lang->line('open_share_status'); ?></option>
                    <option value="0"><?= $this->lang->line('closed_share_status'); ?></option>
                </select>
            </div>
            <div class="clearfix"></div>
        </div>
        <?php
        $this->event->register("ShareCreateFormRow");
        ?>
